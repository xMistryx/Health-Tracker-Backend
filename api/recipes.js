...
router.post("/", requireUser, requireBody(["name", "description", "ingredients", "instructions"]), async (req, res) => {
  try {
...
router.put("/:id", requireUser, requireBody(["name", "description", "ingredients", "instructions"]), async (req, res) => {
  try {
